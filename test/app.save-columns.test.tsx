...
import type { NavigationState } from "../source/types/navigation.js";
...
vi.mock("../source/components/columns/index.js", () => ({
...
vi.mock("../source/hooks/use-temporary-status-message.js", () => ({
...
vi.mock("../source/hooks/use-columns.js", () => ({
  useColumns: () => ({
...
vi.mock("../source/hooks/use-category-data.js", () => ({
  useCategoryData: () => ({
    items: [],
    loading: false,
    error: undefined,
...
vi.mock("../source/hooks/use-action-handler.js", () => ({
  useActionHandler: () => mocks.actionHandler,
}));

vi.mock("../source/hooks/use-keyboard.js", () => ({
  useKeyboard: () => undefined,
}));

vi.mock("../source/hooks/use-webhook-operations.js", () => ({
...
vi.mock("../source/state/context.js", () => ({
...
vi.mock("../source/state/client-context.js", () => ({
